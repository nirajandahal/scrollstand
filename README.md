...
Hands-free PDF reader. Open a PDF, set a speed in lines per minute, and it scrolls for you. Built as a single HTML/CSS/JS page and packaged for Android with Capacitor.
...
| `scripts/build-web.mjs` | Copies the app plus PDF.js and fonts into `www/` for offline use |
